...
function init() {
    //init data
    var json = {"children":[{"children":[],"data":{"progress":100,"tests":2,"pending":0,"$color":"#00ff00","$area":10,"steps":10,"failing":0,"type":"tag","passing":2},"id":"mail ru login form","name":"mail ru login form"}],"data":{},"id":"root","name":"Application"};
    //end
    //init TreeMap
